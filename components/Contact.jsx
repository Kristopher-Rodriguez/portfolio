            ...
            <div className="lg:p-4 h-full">
              <div>
                <img
                  ...
                  src="https://images.pexels.com/photos/374720/pexels-photo-374720.jpeg"
                  alt="/"
                />
              </div>
              <div>
                <h2 className="py-2">Kris Rodriguez</h2>
            ...
            <div className="p-4">
              <form>
                ...
                <div className="flex flex-col py-2">
                  ...
                  <textarea
                    className="border-2 rounded-lg p-3 border-gray-30"
                    rows="10"
                  ></textarea>
                </div>
        ...
        <div className="flex justify-center py-12">
          <Link href="/#home">
            <div className="rounded-full shadow-lg shadow-gray-400 p-4 cursor-pointer hover:scale-110 ease-in duration-100">
              <HiOutlineChevronDoubleUp className="text-[#2cadad]" size={30}/>
            </div>
          </Link>
        </div>
      </div>
